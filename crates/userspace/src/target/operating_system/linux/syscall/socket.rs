...
#[inline(always)]
pub fn socket(fd: isize, a: u32, b: u32) -> crate::Result {
    let arch_result = Arch::syscall3(NUMBER, fd as usize, a as usize, b as usize);
    ...
    match result {
        crate::Result::Ok(
            ...
            core::result::Result::Ok(
                ...
                crate::target::os::syscall::Ok::Socket(
                crate::target::os::syscall::socket::Ok::Default(m),
            ))))),
        _ =>
            core::result::Result::Err(
                ...
                crate::target::os::syscall::Error::Socket(
                Error::Default(3),
            ))))),
    }
}
